...
# App Title
st.title("Sales Content Creator")
st.markdown("Generate persuasive sales content, analyze images, or create sales code!")
...
if not check_backend_connection():
    ...
    2. The sales_data directory contains text files
...
with tab1:
    with st.form("text_form"):
        prompt = st.text_area(
            "Enter your sales prompt (e.g., 'Create a pitch for a software product')",
            placeholder="Type your sales content request here...",
            key="text_prompt"
        )
...
with tab2:
    with st.form("image_form"):
        uploaded_file = st.file_uploader("Upload an image for sales analysis", type=["png", "jpg", "jpeg"])
...
with tab3:
    with st.form("code_form"):
        code_prompt = st.text_area(
            "Enter your code prompt (e.g., 'Generate HTML for a sales landing page')",
            placeholder="Type your sales code request here...",
            key="code_prompt"
        )
